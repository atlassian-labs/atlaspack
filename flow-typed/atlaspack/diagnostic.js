declare module "@atlaspack/diagnostic" {
  import type { Mapping } from "@mischnic/json-sourcemap";

  /**
   * These positions are 1-based (so <code>1</code> is the first line/column)
   */
  declare export type DiagnosticHighlightLocation = {|
    +line: number,
    +column: number,
  |};

  declare export type DiagnosticSeverity = "error" | "warn" | "info";
  /**
  ...
  declare export type DiagnosticCodeHighlight = {|
    /**
   ...
   */
  declare export type DiagnosticCodeFrame = {|
    /**
   ...
   */
  declare export type JSONObject = {
    [key: string]: any,
  };
  /**
  ...
  declare export interface PrintableError extends Error {
    fileName?: string;
    filePath?: string;
    codeFrame?: string;
  ...
  declare export type DiagnosticWithoutOrigin = {|
    ...Diagnostic,
    origin?: string,
  |};
   ...
   */
  declare export type Diagnostifiable =
    | Diagnostic
    | Array<Diagnostic>
    | ThrowableDiagnostic
    | PrintableError
  ...
  declare export type ThrowableDiagnosticOpts = {
  ...
  declare export type TemplateInput = $FlowFixMe;
  declare export interface MdFunction {
  ...
  declare export var md: MdFunction;
}
