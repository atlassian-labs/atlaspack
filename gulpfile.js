...
gulp.task('unified:post', (cb) => {
  execSync(
    'node --experimental-strip-types --disable-warning=ExperimentalWarning ./scripts/unified/build-ts.mts',
    {
      cwd: __dirname,
      shell: true,
      stdio: 'inherit',
  ...
  execSync(
    'node --experimental-strip-types --disable-warning=ExperimentalWarning ./scripts/unified/generate-vendored.mts',
    {
      cwd: __dirname,
      shell: true,
      stdio: 'inherit',
...
function unified() {
  return gulp
    .src([
      'packages/unified/src/**/*.js',
      '!packages/unified/src/vendor/**',
      '!packages/unified/src/**/*.test.*',
    ])
    .pipe(
      babel({
        ...babelConfig,
