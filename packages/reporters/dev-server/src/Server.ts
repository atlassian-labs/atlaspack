...
export default class Server {
  ...
  async serveBundle(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  async start(): Promise<HTTPServer> {
    ...
    return new Promise((resolve: (result: Promise<Server> | Server) => void, reject: (error?: any) => void) => {
