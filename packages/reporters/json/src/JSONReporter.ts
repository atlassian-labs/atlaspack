...
function makeWriter(write: (arg1: string) => unknown): (arg1: JSONReportEvent, arg2: keyof typeof LOG_LEVELS) => void {
  return (event: JSONReportEvent, logLevelFilter: keyof typeof LOG_LEVELS): void => {
    let stringified;
    try {
...
function writeLogEvent(event: LogEvent, logLevelFilter: keyof typeof LOG_LEVELS): void {
...
function progressEventToJSONEvent(progressEvent: BuildProgressEvent): JSONProgressEvent | null | undefined {
