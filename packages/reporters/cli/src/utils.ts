...
export function pad(text: string, length: number, align: PadAlign = 'left'): string {
...
export function formatFilename(filename: string, color: (s: string) => string = chalk.reset): string {
