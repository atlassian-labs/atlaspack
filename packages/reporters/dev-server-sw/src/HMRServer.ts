...
export async function getHotAssetContents(bundleGraph: BundleGraph<PackagedBundle>, asset: Asset): Promise<string> {
...
function getSourceURL(bundleGraph: BundleGraph<PackagedBundle>, asset: Asset) {
