...
export type ParcelSeverity = unknown;

export function parcelSeverityToLspSeverity(parcelSeverity: ParcelSeverity): ODiagnosticSeverity {
...
export function normalizeFilePath(filePath: FilePath, projectRoot: FilePath): FilePath {
