...
let bundleDependencies = new WeakMap<NamedBundle, {
...
function getLoaderRuntime(
  ...
  function getLoaderForBundle(bundle: NamedBundle, to: NamedBundle): string | undefined {
...
function getHintedBundleGroups(bundleGraph: BundleGraph<NamedBundle>, bundle: NamedBundle): {
...
function isNewContext(bundle: NamedBundle, bundleGraph: BundleGraph<NamedBundle>): boolean {
...
function getRegisterCode(entryBundle: NamedBundle, bundleGraph: BundleGraph<NamedBundle>): string {
...
function getRelativePathExpr(from: NamedBundle, to: NamedBundle, options: PluginOptions): string {
...
function shouldUseRuntimeManifest(bundle: NamedBundle, options: PluginOptions): boolean {
  let env = bundle.env;
  return (
    !env.isLibrary &&
