...
function getDependencies(bundle: NamedBundle): {
  ...
  if (cachedDependencies) {
    ...
    let asyncDependencies: Array<never> = [];
    let otherDependencies: Array<never> = [];
    let conditionalDependencies: Array<never> = [];
...
function getHintedBundleGroups(
  ...
  let preload: Array<never> = [];
  let prefetch: Array<never> = [];
