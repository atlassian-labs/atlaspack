...
describe.v2('css', () => {
  ...
  it('should produce two bundles when importing a CSS file', async () => {
    let b = await bundle(path.join(__dirname, '../data/integration/css/index.js'));
  ...
  it('should bundle css dependencies in the correct, postorder traversal order', async () => {
    let b = await bundle(path.join(__dirname, '../data/integration/css-order/a.css'));
  ...
  it('should place one css bundle per bundlegroup for naming reasons', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/multi-css-bug/src/entry.js'),
    );
  ...
  it.skip('create a new css bundle to maintain one css bundle per bundlegroup constraint', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/multi-css-multi-entry-bug/src/entry.js',
      ),
    );
  ...
  it('should support loading a CSS bundle along side dynamic imports', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-css/index.js'),
    );
  ...
  it('should support importing CSS from a CSS file', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-import/index.js'),
    );
  ...
  it('should support linking to assets with url() from CSS', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/css-url/index.js'));
  ...
  it('should support linking to assets with url() from CSS in production', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-url/index.js'),
      {
  ...
  it('should support linking to assets in parent folders with url() from CSS', async function () {
    let b = await bundle(
      [
        path.join(__dirname, '../data/integration/css-url-relative/src/a/style1.css'),
        path.join(__dirname, '../data/integration/css-url-relative/src/b/style2.css'),
      ],
      {
        defaultTargetOptions: {
          shouldOptimize: true,
  ...
  it('should handle quote in CSS URL correctly', async function () {
    await bundle(path.join(__dirname, '../data/integration/css-url-quote/index.css'));
  ...
  it('should ignore url() with IE behavior specifiers', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-url-behavior/index.css'),
    );
  ...
  it('should throw a diagnostic for relative url() dependencies in custom properties', async function () {
    let fixture = path.join(
      __dirname,
      '../data/integration/css-url-custom-property/index.css',
    );
  ...
  it('should minify CSS when minify is set', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/cssnano/index.js'),
      {
        defaultTargetOptions: {
          shouldOptimize: true,
          sourceMaps: false,
  ...
  it('should produce a sourcemap when sourceMaps are used', async function () {
    await bundle(path.join(__dirname, '../data/integration/cssnano/index.js'), {
      defaultTargetOptions: {
        shouldOptimize: true,
      },
    });
    ...
    assert(map.sources.includes('../data/integration/cssnano/local.css'));
    assert(map.sources.includes('../data/integration/cssnano/index.css'));
  });

  it('should inline data-urls for text-encoded files', async () => {
    await bundle(path.join(__dirname, '../data/integration/data-url/text.css'), {
      defaultTargetOptions: {
        sourceMaps: false,
      },
    });
  ...
  it('should inline data-urls for binary files', async () => {
    await bundle(path.join(__dirname, '../data/integration/data-url/binary.css'));
  ...
  it('should remap locations in diagnostics using the input source map', async () => {
    let fixture = path.join(
      __dirname,
      '../data/integration/diagnostic-sourcemap/index.scss',
    );
    let code = await inputFS.readFileSync(fixture, 'utf8');
    // $FlowFixMe
    await assert.rejects(
  ...
  it('should support importing CSS from node_modules with the npm: scheme', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-node-modules/index.css'),
    );
  ...
  it('should support the style package exports condition', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-exports/index.css'),
    );
  ...
  it('should support external CSS imports', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-external/a.css'),
    );
...
.a {
  ...
  it('should support css nesting with lightningcss', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/css-nesting/a.css'),
      {
        defaultTargetOptions: {
          engines: {},
        },
  ...
  it('should support @layer', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/css-layer/a.css'), {
      mode: 'production',
    });
