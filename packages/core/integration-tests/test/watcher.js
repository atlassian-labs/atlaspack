...
describe.v2('watcher', function () {
  ...
  it('should rebuild on a config file change', async function () {
    let inDir = path.join(__dirname, '../data/integration/parcelrc-custom');
    let outDir = path.join(inDir, 'dist');

    await ncp(path.join(__dirname, '../data/integration/parcelrc-custom'), inDir);
    await ncp(
  ...
  it('should rebuild properly when a dependency is removed', async function () {
    await ncp(path.join(__dirname, '../data/integration/babel-default'), inputDir);
  ...
  it.skip('should re-generate bundle tree when files change', async function () {
    await ncp(path.join(__dirname, '../data/integration/dynamic-hoist'), inputDir);
  ...
  it.skip('should rebuild if the file behind a symlink changes', async function () {
    await ncp(
      path.join(__dirname, '../data/integration/commonjs-with-symlinks/'),
      inputDir,
    );
  ...
  it('should add and remove necessary runtimes to bundles', async () => {
    await ncp(path.join(__dirname, '../data/integration/dynamic'), inputDir);
