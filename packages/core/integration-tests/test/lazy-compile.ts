...
const findBundle = (bundleGraph: BundleGraph<PackagedBundle>, nameRegex: RegExp): NamedBundle => {
...
const distDirIncludes = async (matches: Array<RegExp | string>) => {
