...
describe.v2('proxy', function () {
  ...
  it('should handle proxy table written in .proxyrc', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc');
    inputFS.chdir(dir);
  ...
  it('should handle proxy table written in .proxyrc.json', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc-json');
    inputFS.chdir(dir);
  ...
  it('should handle proxy table written in .proxyrc.js', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc-js');
    inputFS.chdir(dir);
  ...
  it('should handle proxy table written in .proxyrc.cjs', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc-cjs');
    inputFS.chdir(dir);
  ...
  it('should handle proxy table written in .proxyrc.mjs', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc-mjs');
    inputFS.chdir(dir);
  ...
  it('should handle proxy table written in .proxyrc.ts', async function () {
    let dir = path.join(__dirname, '../data/integration/proxyrc-ts');
    inputFS.chdir(dir);
