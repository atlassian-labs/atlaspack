...
describe('fs', function () {
  ...
  describe('browser environment', function () {
    it('should not inline a file if disabled via config', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-disabled/index.js'),
        {
          inputFS: overlayFS,
        },
      );
    ...
    it('should not inline a file outside of the project root', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-outside-root/index.js'),
        {
          inputFS: overlayFS,
        },
      );
    ...
    it('should inline a file as a string', async function () {
      let b = await bundle(path.join(__dirname, '../data/integration/fs/index.js'));
    ...
    it('should inline a file as a buffer', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-buffer/index.js'),
      );
      let output = await run(b);
    ...
    it('should inline a file with fs require alias', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-alias/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it('should inline a file with fs require inline', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-inline/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it.skip('should inline a file with fs require assignment', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-assign/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it.skip('should inline a file with fs require assignment alias', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-assign-alias/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it('should inline a file with fs require destructure', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-destructure/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it.skip('should inline a file with fs require destructure assignment', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-destructure-assign/index.js'),
      );
      let output = await run(b);
      assert.equal(output, 'hello');
    });
    ...
    it('should inline a file with fs ES6 import', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-import/index.js'),
      );
      let output = await run(b);
      invariant(typeof output === 'object' && output != null);
    ...
    it('should inline a file with fs ES6 import and path.join', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-import-path-join/index.js'),
      );
      let output = await run(b);
      invariant(typeof output === 'object' && output != null);
      assert.equal(output.default, 'hello');
    ...
    it.v2(
      ...
      async function () {
        let b = await bundle(
          path.join(__dirname, '../data/integration/resolve-entries/ignore-fs.js'),
        );
    ...
    it('should ignore fs calls when the filename is not evaluable', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-file-non-evaluable/index.js'),
      );
    ...
    it('should ignore fs calls when the filename is not evaluable after preset-env', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '/../data/integration/fs-file-non-evaluable-template-env/index.js',
        ),
      );
    ...
    it('should ignore fs calls when the options are not evaluable', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-options-non-evaluable/index.js'),
      );
  ...
  describe('node environment', function () {
    it('should not inline a file in a node environment', async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/fs-node/index.js'),
      );
      ...
      await outputFS.writeFile(
        path.join(__dirname, '../data/integration/fs-node/', 'test.txt'),
        'hey',
      );
      let output = await run(b);
