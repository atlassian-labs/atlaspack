...
describe.v2('html', function () {
  ...
  it('should support bundling HTML', async () => {
    let b = await bundle(path.join(__dirname, '../data/integration/html/index.html'));
  ...
  it('should support pkg#source array as entrypoints', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-pkg-source-array'),
    );
  ...
  it('should find href attr when not first', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-attr-order/index.html'),
    );
  ...
  it('should insert empty script tag for HMR at the end of the body', async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/html-no-js/index.html'),
      {
        hmrOptions: {},
      },
    );
  ...
  it('should insert empty script tag for HMR at the implied </body>', async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/html-no-js/no-body.html'),
      {
        hmrOptions: {},
      },
    );
  ...
  it('should insert empty script tag for HMR at the end of the file if both </body> and </html> are implied', async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/html-no-js/no-body-or-html.html'),
      {
        hmrOptions: {},
      },
    );
  ...
  it('should insert empty script tag for HMR at the end of the body when having normal inline script', async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-js/index.html'),
      {
        hmrOptions: {},
      },
    );
  ...
  it('should support canonical links', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-canonical/index.html'),
    );
  ...
  it('should support RSS feed links', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-feed/rss.html'),
    );
  ...
  it('should support atom feed links', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-feed/atom.html'),
    );
  ...
  it('should support meta tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-meta/index.html'),
    );
  ...
  it('should insert sibling CSS bundles for JS files in the HEAD', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-css/index.html'),
    );
  ...
  it('should insert sibling bundles before body element if no HEAD', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-css-head/index.html'),
    );
  ...
  it('should insert sibling bundles after doctype if no html', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-css-doctype/index.html'),
    );
  ...
  it.skip('should insert sibling JS bundles for CSS files in the HEAD', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-css-js/index.html'),
      {
        hmr: true,
      },
    );
  ...
  it('should insert sibling bundles at correct location in tree when optional elements are absent', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/html-css-optional-elements/index.html',
      ),
    );
  ...
  it('should combine sibling CSS from multiple script tags into one bundle', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-css-multi/index.html'),
    );
  ...
  it('should deduplicate shared code between script tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-js-dedup/index.html'),
    );
  ...
  it('should minify HTML in production mode', async function () {
    let inputFile = path.join(__dirname, '../data/integration/htmlnano/index.html');
  ...
  it('should work with an empty html file', async function () {
    let inputFile = path.join(__dirname, '../data/integration/html-empty/index.html');
    await bundle(inputFile, {
      defaultTargetOptions: {
  ...
  it('should work with an invalid html file', async function () {
    let inputFile = path.join(
      __dirname,
      '/../data/integration/html-invalid/index.html',
    );
    await bundle(inputFile, {
      defaultTargetOptions: {
        shouldOptimize: false,
  ...
  it("should work with html that doesn't include optional closing tags", async function () {
    let inputFile = path.join(
      __dirname,
      '/../data/integration/html-optional-closing-tags/index.html',
    );
    await bundle(inputFile, {
      defaultTargetOptions: {
        shouldOptimize: false,
  ...
  it('should read .htmlnanorc.json and minify HTML in production mode', async function () {
    await bundle(
      path.join(__dirname, '../data/integration/htmlnano-config/index.html'),
      {
        defaultTargetOptions: {
          shouldOptimize: true,
        },
  ...
  it('should not minify default values inside HTML in production mode', async function () {
    let inputFile = path.join(
      __dirname,
      '/../data/integration/htmlnano-defaults-form/index.html',
    );
    await bundle(inputFile, {
      defaultTargetOptions: {
        shouldOptimize: true,
  ...
  it('should not prepend the public path to assets with remote URLs', async function () {
    await bundle(path.join(__dirname, '../data/integration/html/index.html'));
  ...
  it('should detect virtual paths', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-virtualpath/index.html'),
    );
  ...
  it('should not update root/main file in the bundles', async function () {
    await bundle(path.join(__dirname, '../data/integration/html-root/index.html'));
  ...
  it('should support child bundles of different types', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/child-bundle-different-types/index.html',
      ),
    );
  ...
  it.skip('should support circular dependencies', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/circular/index.html'),
    );
  ...
  it('should support bundling HTM', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/htm-extension/index.htm'),
    );
  ...
  it('should detect srcset attribute', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-srcset/index.html'),
    );
  ...
  it('should detect srcset attribute of source element', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-source-srcset/index.html'),
    );
  ...
  it('should detect imagesrcset attribute', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-imagesrcset/index.html'),
    );
  ...
  it.skip("should treat webmanifest as an entry module so it doesn't get content hashed", async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/html-manifest/index.html'),
    );
  ...
  it('should bundle svg files correctly', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-svg/index.html'),
    );
  ...
  it('should ignore svgs referencing local symbols via <use xlink:href="#">', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-svg-local-symbol/index.html'),
      {
        mode: 'production',
      },
    );
  ...
  it('should bundle svg files using <image xlink:href=""> correctly', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-svg-image/index.html'),
    );
  ...
  it("should support href attribute in <image /> in HTMLTransformer's collectDependencies", async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-image-href-attr/index.html'),
    );
  ...
  it('should bundle scripts inside svg', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-svg-script/index.html'),
    );
  ...
  it('should support data attribute of object element', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-object/index.html'),
    );
  ...
  it('should resolve assets containing spaces', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-spaces/index.html'),
    );
  ...
  it('should process inline styles', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-styles/index.html'),
      {
        defaultTargetOptions: {
          shouldOptimize: true,
        },
  ...
  it('should process inline element styles', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/html-inline-styles-element/index.html',
      ),
  ...
  it('should process inline styles using lang', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-sass/index.html'),
      {
        defaultTargetOptions: {
          shouldOptimize: true,
        },
  ...
  it('should handle inline css with @imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-css-import/index.html'),
    );
  ...
  it('should not modify inline importmaps', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-importmap/index.html'),
      {},
    );
  ...
  it('should expose top level declarations globally in inline <script> tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-js-script/globals.html'),
    );
    ...
    it(
      ...
      async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/html-inline-js-script/globals-dependencies.html',
          ),
          {
            defaultTargetOptions: {
  ...
  it('should error on imports in inline scripts without type="module"', async function () {
    ...
    try {
      await bundle(
        path.join(__dirname, '../data/integration/html-inline-js-script/error.html'),
      );
    } catch (err) {
      assert.equal(
        err.message,
          ...
          codeFrames: [
            {
              filePath: path.join(
                __dirname,
                '/../data/integration/html-inline-js-script/error.html',
              ),
              codeHighlights: [
                {
                  message: undefined,
  ...
  it('should not import swc/helpers without type="module"', async function () {
    await bundle(
      path.join(
        __dirname,
        '/../data/integration/html-js-not-import-swc-helpers-without-module/index.html',
      ),
      {
        defaultTargetOptions: {
          engines: {
  ...
  it('should allow imports and requires in inline <script> tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-js-require/index.html'),
      {
        defaultTargetOptions: {
          shouldOptimize: true,
        },
  ...
  it('should support protocol-relative urls', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-protocol-relative/index.html'),
    );
  ...
  it('should support inline <script type="module">', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-js-module/index.html'),
      {
        defaultTargetOptions: {
  ...
  it('should error on imports in scripts without type="module"', async function () {
    let errored = false;
    try {
      await bundle(path.join(__dirname, '../data/integration/html-js/error.html'));
    } catch (err) {
      assert.equal(
        err.message,
        'Browser scripts cannot have imports or exports.',
      ...
      assert.deepEqual(err.diagnostics, [
        {
          ...
          codeFrames: [
            {
              filePath: path.join(__dirname, '../data/integration/html-js/index.js'),
              codeHighlights: [
                {
                  message: undefined,
                  start: {
            ...
            {
              filePath: path.join(__dirname, '../data/integration/html-js/error.html'),
              codeHighlights: [
                {
  ...
  it('should correctly bundle loaders for nested dynamic imports', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/html-js-shared-dynamic-nested/index.html',
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should support shared bundles between multiple inline scripts', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-js-shared/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('inserts sibling bundles into html in the correct order (no head)', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-js-shared/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('inserts sibling bundles into html in the correct order (head)', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-js-shared-head/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('inserts sibling bundles into html with nomodule or type=module', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-js-shared-nomodule/*.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('supports multiple dist targets', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-multi-targets/'),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should isolate async scripts', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-async-script/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('should isolate classic scripts from nomodule scripts', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-isolate-script/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('should support multiple entries with shared sibling bundles', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/shared-sibling-entries/*.html'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
  ...
  it('should not point to unrelated sibling bundles', async function () {
    await bundle(
      path.join(
        __dirname,
        '/../data/integration/shared-sibling-entries-multiple/*.html',
      ),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
  ...
  it('should support split bundles with many pages', async function () {
    await bundle(path.join(__dirname, '../data/integration/shared-many/*.html'), {
      mode: 'production',
    });
  ...
  it('should not add CSS to a worker bundle group', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/shared-sibling-worker-css/index.html'),
    );
  ...
  it('should correctly add sibling bundles to all using bundles', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/shared-sibling/*.html'),
    );
  ...
  it('should remove duplicate assets from sibling bundles', async function () {
    let bundleGraph = await bundle(
      path.join(__dirname, '../data/integration/shared-sibling-duplicate/*.html'),
      {mode: 'production'},
    );
  ...
  it('should support split bundles with many pages with esmodule output', async function () {
    await bundle(path.join(__dirname, '../data/integration/shared-many-esm/*.html'), {
      defaultTargetOptions: {
        shouldScopeHoist: true,
      },
    });
  ...
  it('should include the correct paths when using multiple entries and referencing style from html and js', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-multi-entry/*.html'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
  ...
  it('should invalidate parent bundle when inline bundles change', async function () {
    // copy into memory fs
    await ncp(
      path.join(__dirname, '../data/integration/html-inline-js-require'),
  ...
  it('should invalidate parent bundle when nested inline bundles change', async function () {
    // copy into memory fs
    await ncp(
      path.join(__dirname, '../data/integration/html-inline-js-nested'),
  ...
  it('should inline data-urls', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/data-url/index.html'),
      {
        defaultTargetOptions: {
          sourceMaps: false,
        },
  ...
  it('should print a diagnostic for invalid bundler options', async () => {
    let dir = path.join(__dirname, '../data/integration/invalid-bundler-config');
  ...
  it('should escape inline script tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-escape/script.html'),
    );
    let output;
    await run(b, {
      output(o) {
  ...
  it('should escape quotes in inline style attributes and style tags', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-inline-escape/style.html'),
    );
  ...
  it('should work with bundle names that have colons in them', async function () {
    ...
    await overlayFS.mkdirp(path.join(__dirname, '../data/integration/url-colon'));
    await overlayFS.writeFile(
      path.join(__dirname, '../data/integration/url-colon/a:b:c.html'),
      '<p>Test</p>',
    );

    let b = await bundle(
      path.join(__dirname, '../data/integration/url-colon/relative.html'),
      {inputFS: overlayFS},
    );
    ...
    b = await bundle(
      path.join(__dirname, '../data/integration/url-colon/absolute.html'),
      {inputFS: overlayFS},
    );
  ...
  it('should normalize case of SVG elements and attributes when minified', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-svg-case/index.html'),
      {
        mode: 'production',
      },
    );
  ...
  it('should throw error with empty string reference to other resource', async function () {
    await assert.rejects(
      () =>
        bundle(
          path.join(__dirname, '../data/integration/html-empty-reference/index.html'),
          {
            mode: 'production',
          },
        ),
            ...
            codeFrames: [
              {
                filePath: path.join(
                  __dirname,
                  '../data/integration/html-empty-reference/index.html',
                ),
                language: 'html',
                codeHighlights: [
                  {
  ...
  it('extracts shared bundles that load referenced bundle roots across entries', async () => {
    let b = await bundle(
      ['index1.html', 'index2.html'].map(entry =>
        path.join(__dirname, '../data/integration/html-shared-referenced', entry),
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should not skip bundleRoots if an asset is both async required and static required', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/html-sync-async-asset/index.html'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldOptimize: false,
