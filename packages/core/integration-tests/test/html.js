...
describe.v2('html', function () {
  ...
  it.v2('should support canonical links', async function () {
    let b = await bundle(
  ...
  it.v2(
    'should deduplicate shared code between script tags',
    async function () {
      let b = await bundle(
  ...
  it.v2('should not update root/main file in the bundles', async function () {
  ...
  it.v2('should support child bundles of different types', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.v2('should resolve assets containing spaces', async function () {
    let b = await bundle(
  ...
  it.v2('should not modify inline importmaps', async function () {
    let b = await bundle(
  ...
  it.v2(
    'should remove type="module" when not scope hoisting',
    async function () {
      let b = await bundle(
        path.join(__dirname, '/integration/html-js/index.html'),
      );
