...
describe.only('html', function () {
  ...
  it.v2('should process inline JS', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/html-inline-js/index.html'),
      {
        defaultTargetOptions: {
  ...
  it.only('should not modify inline importmaps', async function () {
    let b = await bundle(
  ...
  it.v2(
    'should expose top level declarations globally in inline <script> tags',
    async function () {
      let b = await bundle(
  ...
  it.v2(
    'should not import swc/helpers without type="module"',
    async function () {
      await bundle(
        path.join(
          __dirname,
  ...
  it.v2(
    'should allow imports and requires in inline <script> tags',
    async function () {
      let b = await bundle(
  ...
  it.v2('should support inline <script type="module">', async function () {
    let b = await bundle(
  ...
  it.v2('should support split bundles with many pages', async function () {
  ...
  it.v2(
    'should remove duplicate assets from sibling bundles',
    async function () {
  ...
  it.v2(
    'should support split bundles with many pages with esmodule output',
    async function () {
      await bundle(
  ...
  it.v2('should escape inline script tags', async function () {
    let b = await bundle(
  ...
  it.v2(
    'should share older JS sibling (script) assets to younger siblings',
    async function () {
  ...
  it.v2(
    'extracts shared bundles that load referenced bundle roots across entries',
    async () => {
      let b = await bundle(
  ...
  it.v2(
    'should not skip bundleRoots if an asset is both async required and static required',
    async function () {
      let b = await bundle(
