...
describe('javascript', function () {
  ...
  it('should produce a basic JS bundle with CommonJS requires', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/commonjs/index.js'),
    );
  ...
  it.v2('should support url: imports with CommonJS output', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/commonjs-import-url/index.js'),
    );
  ...
  it('should produce a basic JS bundle with ES6 imports', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/es6/index.js'), {
      outputFS: inputFS,
    });
  ...
  it('should detect dependencies inserted by a prior transform', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dependency-prior-transform/index.js'),
    );
  ...
  it('should ignore unused requires after process.env inlining', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-unused-require/index.js'),
      {
        env: {ABC: 'XYZ'},
      },
    );
  ...
  it('should produce a basic JS bundle with object rest spread support', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/object-rest-spread/object-rest-spread.js',
      ),
    );
  ...
  it('should bundle node_modules for a browser environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/node_require_browser/main.js'),
    );
  ...
  it('should not bundle node_modules for a node environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/node_require/main.js'),
    );
  ...
  it('should preserve hashbangs in bundles and preserve executable file mode', async () => {
    let fixturePath = path.join(__dirname, '../data/integration/node_hashbang');
  ...
  it('should preserve hashbangs in scopehoisted bundles', async () => {
    let fixturePath = path.join(__dirname, '../data/integration/node_hashbang');
    await bundle(path.join(__dirname, '../data/integration/node_hashbang/main.js'), {
  ...
  it('should bundle node_modules for a node environment if includeNodeModules is specified', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/include_node_modules/main.js'),
    );
  ...
  it('should bundle builtins for a browser environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/include_builtins-browser/main.js'),
    );
  ...
  it('should not bundle builtins for a node environment if includeNodeModules is specified', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/include_builtins-node/main.js'),
    );
  ...
  it('should produce a JS bundle with default exports and no imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/es6-default-only/index.js'),
    );
  ...
  it('should split bundles when a dynamic import is used a browser environment', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/dynamic/index.js'));
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/dynamic-static-prefetch/index.js'),
      );
  ...
  it.v2('should load additional links that were prefetched', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/dynamic-static-prefetch-loaded/index.js',
      ),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/dynamic-static-preload/index.js'),
      );
  ...
  it('should remove import attributes', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-import-attributes/index.js'),
    );
  ...
  it('should split bundles when a dynamic import is used with a node environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-node/index.js'),
    );
  ...
  it('should split bundles when a dynamic import is used with an electron-main environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-electron-main/index.js'),
    );
  ...
  it('should split bundles when a dynamic import is used with an electron-renderer environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-electron-renderer/index.js'),
    );
  ...
  it.skip('should load dynamic bundle when entry is in a subdirectory', async function () {
    let bu = await bundler(
      path.join(
        __dirname,
        '/../data/integration/dynamic-subdirectory/subdirectory/index.js',
      ),
      {
        target: 'browser',
      },
    ...
    bu.options.rootDir = path.join(
      __dirname,
      '/../data/integration/dynamic-subdirectory',
    );
  ...
  it.skip('Should not run parcel over external modules', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-external/index.js'),
    );
  ...
  it('dynamic imports loaded as high-priority scripts when not all engines support esmodules natively', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-imports-high-prio/index.js'),
      {
        defaultTargetOptions: {
          engines: {
            browsers: 'IE 11',
  ...
  it('should deduplicate and remove an unnecessary async bundle when it contains a cyclic reference to its entry', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/deduplicate-from-async-cyclic-bundle-entry/index.js',
      ),
    );
  ...
  it('does not create bundles for dynamic imports when assets are available up the graph', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/internalize-no-bundle-split/index.js'),
    );
  ...
  it('should dynamic import files which import raw files', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-references-raw/index.js'),
    );
  ...
  it('should return all exports as an object when using ES modules', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-esm/index.js'),
    );
  ...
  it('should duplicate small modules across multiple bundles', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-common-small/index.js'),
    );
  ...
  it('should create a separate bundle for large modules shared between bundles', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-common-large/index.js'),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should not duplicate a module which is already in a parent bundle', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-hoist-dup/index.js'),
    );
  ...
  it('should duplicate an asset if it is not present in every parent bundle', async function () {
    let b = await bundle(
      ['a.js', 'b.js'].map(entry =>
        path.join(__dirname, '../data/integration/dynamic-hoist-no-dedupe', entry),
      ),
    );
    assertBundles(b, [
      {
  ...
  it('should duplicate an asset if it is not available in all possible ancestries', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/dynamic-hoist-no-dedupe-ancestry/index.js',
      ),
    );
  ...
  it('should support shared modules with async imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dynamic-hoist-deep/index.js'),
    );
  ...
  it.v2('should support importing a URL to a raw asset', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/import-raw/index.js'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '/../data/integration/import-raw-import-meta-url/index.js',
        ),
      );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/import-raw-import-meta-url/cjs.js'),
      );
  ...
  it('should ignore new URL and import.meta.url with local binding', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/import-raw-import-meta-url/local-url.js',
      ),
    );
  ...
  it.v2(
    ...
    async function () {
      let fixture = path.join(
        __dirname,
        '../data/integration/import-raw-import-meta-url/missing.js',
      );
  ...
  it.v2(
    ...
    async function () {
      ...
      let fixtureDir = path.join(__dirname, '../data/integration/import-raw');
  ...
  it('should minify JS in production mode', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/uglify/index.js'), {
      defaultTargetOptions: {
        shouldOptimize: true,
        shouldScopeHoist: false,
      },
  ...
  it('should use terser config', async function () {
    await bundle(path.join(__dirname, '../data/integration/terser-config/index.js'), {
      defaultTargetOptions: {
        shouldOptimize: true,
        shouldScopeHoist: false,
      },
  ...
  it('should insert global variables when needed', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/globals/index.js'));
  ...
  it('should replace __dirname and __filename with path relative to asset.filePath', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-node-replacements/index.js'),
    );
    ...
    assert.equal(
      ...
      path.join(__dirname, '../data/integration/env-node-replacements/data'),
    );
    assert.equal(
      output.secondDirnameTest,
      path.join(__dirname, '../data/integration/env-node-replacements/other-data'),
    );
    assert.equal(
    ...
    assert.equal(
      ...
      path.join(
        __dirname,
        '/../data/integration/env-node-replacements/index.js?query-string=test',
      ),
    );
    assert.equal(
      output.sub.dirname,
      path.join(__dirname, '../data/integration/env-node-replacements/sub'),
    );
    assert.equal(
      output.sub.filename,
      path.join(__dirname, '../data/integration/env-node-replacements/sub/index.js'),
    );
  });
  ...
  it('should work when multiple files use globals with scope hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/globals/multiple.js'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
    ...
    let output = await run(b);
    assert.deepEqual(output, {
      file: '../data/integration/globals/multiple.js',
      other: '../data/integration/globals/index.js',
    });
  });

  it('should not insert global variables when used in a module specifier', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/globals-module-specifier/a.js'),
    );
  ...
  it('should not insert global variables in dead branches', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/globals-unused/a.js'),
    );
  ...
  it('should handle re-declaration of the global constant', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/global-redeclare/index.js'),
    );
  ...
  it.v2(
    ...
    async () => {
      let b = await bundle(
        path.join(__dirname, '../data/integration/env-prior-transform/index.js'),
      );
  ...
  it('should not insert environment variables in node environment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-node/index.js'),
    );
  ...
  it('should not replace process.env.hasOwnProperty with undefined', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-hasOwnProperty/index.js'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(path.join(__dirname, '../data/integration/env/index.js'), {
        targets: {
          main: {
            context: 'electron-main',
            distDir: path.join(__dirname, '../data/integration/env/dist.js'),
          },
        },
      });
  ...
  it('should inline NODE_ENV environment variable in browser environment even if disabled', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-nodeenv/index.js'),
      {
        env: {
          FOO: 'abc',
        },
  ...
  it('should not insert environment variables in browser environment if disabled', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-disabled/index.js'),
      {
        env: {FOOBAR: 'abc'},
      },
    );
  ...
  it('should only insert environment variables in browser environment matching the glob', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-disabled-glob/index.js'),
      {
  ...
  it('should not inline computed accesses to process.env', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-computed/index.js'),
      {
        env: {ABC: 'abc'},
      },
    );
  ...
  it('should inline computed accesses with string literals to process.env', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-computed-string/index.js'),
      {
        env: {ABC: 'XYZ'},
      },
    );
  ...
  it('should inline environment variables when destructured in a variable declaration', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-destructuring/index.js'),
      {
        env: {TEST: 'XYZ'},
        defaultTargetOptions: {
          engines: {
  ...
  it('should inline environment variables when destructured in an assignment', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-destructuring/assign.js'),
      {
        env: {TEST: 'XYZ'},
        defaultTargetOptions: {
          engines: {
  ...
  it('should inline environment variables with in binary expression whose right branch is process.env and left branch is string literal', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-binary-in-expression/index.js'),
      {
        env: {ABC: 'any'},
        defaultTargetOptions: {
          engines: {
  ...
  it('should insert environment variables from a file', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/env-file/index.js'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/env-file-with-package-source'),
      );
  ...
  it.v2('should error on process.env mutations', async function () {
    let filePath = path.join(__dirname, '../data/integration/env-mutate/index.js');
  ...
  it.v2(
    ...
    async function () {
      ...
      let b = await bundle(
        path.join(__dirname, '../data/integration/env-mutate/warn.js'),
      );
      disposable.dispose();
              ...
              codeFrames: [
                {
                  filePath: path.join(
                    __dirname,
                    '/../data/integration/env-mutate/node_modules/foo/index.js',
                  ),
                  codeHighlights: [
                    {
                      message: undefined,
  ...
  it('should replace process.browser for target browser', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/process/index.js'),
      {
        targets: {
          main: {
            context: 'browser',
            distDir: path.join(__dirname, '../data/integration/process/dist.js'),
          },
        },
      },
    );
  ...
  it.skip('should support adding implicit dependencies', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/json/index.js'), {
      delegate: {
  ...
  it('should resolve the browser field before main', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-entries/browser.js'),
    );
  ...
  it.v2(
    ...
    async () => {
      let b = await bundle(
        path.join(
          __dirname,
          '/../data/integration/resolve-entries/pkg-ignore-browser/index.js',
        ),
        {
          targets: ['browsers'],
        },
  ...
  it.skip('should resolve advanced browser resolution', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-entries/browser-multiple.js'),
    );
  ...
  it.skip('should resolve the module field before main if scope-hoisting is enabled', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-entries/module-field.js'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
  ...
  it.skip('should resolve the module field before main if scope-hoisting is enabled', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-entries/both-fields.js'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
  ...
  it('should resolve the main field', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/resolve-entries/main-field.js'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/optional-dep/index.js'),
      );
  ...
  it('should support excluding dependencies in falsy branches', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/falsy-dep/index.js'),
    );
  ...
  it.skip('should not autoinstall if resolve failed on installed module', async function () {
    ...
    try {
      await bundle(
        path.join(
          __dirname,
          '/../data/integration/dont-autoinstall-resolve-fails/index.js',
        ),
      );
    } catch (err) {
      error = err;
  ...
  it.skip('should not autoinstall if resolve failed on aliased module', async function () {
    ...
    try {
      await bundle(
        path.join(
          __dirname,
          '/../data/integration/dont-autoinstall-resolve-alias-fails/index.js',
        ),
      );
    } catch (err) {
      error = err;
  ...
  it('should ignore require if it is defined in the scope', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-scope/index.js'),
    );
  ...
  it('should expose to CommonJS entry point', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/entry-point/index.js'),
    );
  ...
  it.skip('should set `define` to undefined so AMD checks in UMD modules do not pass', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/define-amd/index.js'),
    );
    let test;
    const mockDefine = function (f) {
      test = f();
  ...
  it('should not replace toplevel this with undefined in CommonJS without scope-hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-this-commonjs/a.js'),
    );
  ...
  it('should replace toplevel this with undefined in ESM without scope-hoisting', async function () {
    let b = await bundle(path.join(__dirname, '../data/integration/js-this-es6/a.js'));
  ...
  it('should replace toplevel this with undefined in ESM when scope-hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-this-es6/a.js'),
      {
        defaultTargetOptions: {
          shouldScopeHoist: true,
        },
  ...
  it.skip('should support importing HTML from JS async', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/import-html-async/index.js'),
      {
        defaultTargetOptions: {
          sourceMaps: false,
        },
  ...
  it.skip('should support importing HTML from JS sync', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/import-html-sync/index.js'),
      {
        defaultTargetOptions: {
          sourceMaps: false,
        },
  ...
  it.skip('should stub require.cache', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/node_require_cache/main.js'),
      {
        target: 'node',
      },
    );
  ...
  it('should support async importing the same module from different bundles', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/shared-bundlegroup/index.js'),
    );
  ...
  it('should not create shared bundles from contents of entries', async () => {
    let b = await bundle(
      ['a.js', 'b.js'].map(entry =>
        path.join(
          __dirname,
          '/../data/integration/no-shared-bundles-from-entries/',
          entry,
        ),
      ),
    );
  ...
  it('should import the same dependency multiple times in the same bundle', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/same-dependency-multiple-times/a1.js'),
    );
  ...
  it.v2('should support both pipeline and non-pipeline imports', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/multi-pipeline/index.js'),
    );
  ...
  it('should detect typescript style async requires in commonjs', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/ts.js'),
    );
  ...
  it('should detect typescript style async requires in commonjs with esModuleInterop flag', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/ts-interop.js'),
    );
  ...
  it('should detect typescript style async requires in commonjs with esModuleInterop flag and arrow functions', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/ts-interop-arrow.js'),
    );
  ...
  it('should detect rollup style async requires in commonjs', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/rollup.js'),
    );
  ...
  it('should only detect requires that are returned from the promise', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/sync.js'),
    );
  ...
  it('should properly chain a dynamic import wrapped in a Promise.resolve()', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/resolve-chain.js'),
    );
  ...
  it('should detect parcel style async requires in commonjs', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/require-async/atlaspack.js'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '/../data/integration/commonjs-template-literal-plain/index.js',
        ),
      );
  ...
  it('should detect requires in commonjs with plain template literals', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/commonjs-template-literal-interpolation/index.js',
      ),
    );
    let dist = await outputFS.readFile(
      b.getBundles().find(b => b.type === 'js').filePath,
  ...
  it('only updates bundle names of changed bundles for browsers', async () => {
    let fixtureDir = path.join(__dirname, '../data/integration/name-invalidation');
    let _bundle = () =>
  ...
  it('can load the same resource when referenced in multiple bundles', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/same-resource-multiple-bundles/index.js',
      ),
    );
  ...
  it('can static import and dynamic import in the same bundle without creating a new bundle', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/sync-async/same-bundle.js'),
  ...
  it('async dependency can be resolved internally and externally from two different bundles', async () => {
    let b = await bundle(
      ['entry1.js', 'entry2.js'].map(entry =>
        path.join(
          __dirname,
          '/../data/integration/async-dep-internal-external/',
          entry,
        ),
      ),
      {
  ...
  it('can static import and dynamic import in the same bundle ancestry without creating a new bundle', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/sync-async/same-ancestry.js'),
      {mode: 'production', defaultTargetOptions: {shouldScopeHoist: false}},
    );
  ...
  it('can static import and dynamic import in the same bundle when another bundle requires async', async () => {
    let b = await bundle(
      ['same-bundle.js', 'get-dep.js'].map(entry =>
        path.join(__dirname, '../data/integration/sync-async/', entry),
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it("can share dependencies between a shared bundle and its sibling's descendants", async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/shared-exports-for-sibling-descendant/index.js',
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('can run an async bundle whose entry asset is present in another bundle', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/async-entry-shared/index.js'),
    );
  ...
  it.v2('should display a codeframe on a Terser parse error', async () => {
    let fixture = path.join(__dirname, '../data/integration/terser-codeframe/index.js');
    let code = await inputFS.readFileSync(fixture, 'utf8');
  ...
  it('can share sibling bundles reachable from a common dependency', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/shared-sibling-common-dependency/index.js',
      ),
    );
  ...
  it.v2('should throw a diagnostic for unknown pipelines', async function () {
    let fixture = path.join(__dirname, '../data/integration/pipeline-unknown/a.js');
    let code = await inputFS.readFileSync(fixture, 'utf8');
    await assert.rejects(() => bundle(fixture), {
      name: 'BuildError',
      diagnostics: [
  ...
  it('can create a bundle starting with a dot', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/dotfile-bundle/index.js'),
    );
  ...
  it('should not automatically name bundle files starting with a dot', async function () {
    await bundle(
      path.join(__dirname, '../data/integration/bundle-naming/.invisible/index.js'),
    );
  ...
  it('should support duplicate re-exports without scope hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-duplicate-re-exports/index.js'),
    );
    let res = await run(b);
  ...
  it('should exclude default from export all declaration', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-all/index.js'),
    );
    let res = await run(b);
  ...
  it('should not use arrow functions for reexport declarations unless supported', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-arrow-support/index.js'),
      {
  ...
  it('should support import namespace declarations of other ES modules', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-namespace/a.js'),
    );
    let res = await run(b);
  ...
  it('should support import namespace declarations of class from CJS', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-namespace/b.js'),
    );
    let res = await run(b);
  ...
  it('should support import namespace declarations of object from CJS', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-namespace/c.js'),
    );
    let res = await run(b);
  ...
  it('should support export namespace declarations', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-namespace/index.js'),
    );
    let res = await run(b);
  ...
  it('should support export declarations with destructuring', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-destructuring/index.js'),
    );
    let res = await run(b);
  ...
  it('should support export default declarations', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-default/index.js'),
    );
    let res = await run(b);
  ...
  it('should hoist function default exports to allow circular imports', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/js-export-default-fn-circular-named/a.mjs',
      ),
    );
  ...
  it('should hoist anonymous function default exports to allow circular imports', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '/../data/integration/js-export-default-fn-circular-anonymous/a.mjs',
      ),
    );
  ...
  it('should work with many different types of exports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-many/index.js'),
    );
    let res = await run(b);
  ...
  it('should correctly export functions', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-functions/index.js'),
    );
    let res = await run(b);
  ...
  it('should handle exports of imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-import/index.js'),
    );
    let res = await run(b);
  ...
  it('should handle simultaneous import and reexports of the same identifier', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-export-import-same/index.js'),
    );
    let res = await run(b);
  ...
  it('should generate a unique variable name for imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-shadow/index.js'),
    );
    let res = await run(b);
  ...
  it('should not replace identifier with a var declaration inside a for loop', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-shadow-for-var/index.js'),
    );
    let res = await run(b);
  ...
  it('should replace an imported identifier with function locals of the same name', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-shadow-func-var/index.js'),
    );
    let res = await run(b);
  ...
  it('should replace imported values in member expressions', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-member/index.js'),
    );
    let res = await run(b);
  ...
  it('should retain the correct dependency order between import and reexports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-reexport-dep-order/index.js'),
    );
  ...
  it('should not freeze live default imports', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-import-default-live/index.js'),
    );
    let res = await run(b);
  ...
  it('should only replace free references to require', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-require-free/index.js'),
    );
    let output;
    await run(b, {
      output(v) {
  ...
  it('should support import and non-top-level require of same asset from different assets', async () => {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-require-import-different/index.js'),
    );
  ...
  it('should support runtime module deduplication', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/js-runtime-dedup/index.js'),
    );
  ...
  it.v2(
    ...
    async () => {
      let fixture = path.join(
        __dirname,
        '../data/integration/diagnostic-sourcemap/index.js',
      );
      let code = await inputFS.readFileSync(fixture, 'utf8');
      await assert.rejects(
        () =>
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/shared-bundle-single-source/index.js',
        ),
        {
          mode: 'production',
          defaultTargetOptions: {
  ...
  it.v2(
    ...
    async function () {
      let fixture = path.join(
        __dirname,
        '../data/integration/undeclared-external/index.js',
      );
      let pkg = path.join(
        __dirname,
        '../data/integration/undeclared-external/package.json',
      );
      await assert.rejects(
        () =>
          bundle(fixture, {
  ...
  it.v2(
    ...
    async function () {
      let fixture = path.join(
        __dirname,
        '../data/integration/undeclared-external/helpers.js',
      );
      let pkg = path.join(
        __dirname,
        '../data/integration/undeclared-external/package.json',
  ...
  describe('multiple import types', function () {
    it('supports both static and dynamic imports to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/multiple-import-types/static-dynamic.js',
        ),
      );
    ...
    it('supports static, dynamic, and url to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/multiple-import-types/static-dynamic-url.js',
        ),
      );
    ...
    it('supports dynamic import and url to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/multiple-import-types/dynamic-url.js',
        ),
      );
  ...
  it('should avoid creating a bundle for lazy dependencies already available in a shared bundle', async function () {
    let b = await bundle(
      path.join(
        __dirname,
        '../data/integration/shared-bundle-internalization/index.mjs',
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should support standalone import.meta', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/import-meta/index.js'),
    );
    let res = await run(b);
    assert.deepEqual(res.default, {
  ...
  it('should support importing async bundles from bundles with different dist paths', async function () {
    let bundleGraph = await bundle(
      ['bar/entry/entry-a.js', 'foo/entry-b.js'].map(f =>
        path.join(__dirname, '../data/integration/differing-bundle-urls', f),
      ),
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('supports deferring unused ESM imports with sideEffects: false', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/side-effects-false/import.js'),
    );
  ...
  it('supports ESM imports and requires with sideEffects: false', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/side-effects-false/import-require.js'),
    );
  ...
  it('should not affect ESM import order', async function () {
    const b = await bundle(
      path.join(__dirname, '../data/integration/js-import-initialization/a.mjs'),
    );
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/re-export-no-scope-hoist'),
        {
          defaultTargetOptions: {
            shouldScopeHoist: true,
          },
  ...
  for (let shouldScopeHoist of [false, true]) {
    ...
    describe(`sideEffects: false with${
      ...
      if (usesSymbolPropagation) {
        it.v2('supports excluding unused CSS imports', async function () {
          let b = await bundle(
            path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-css/index.html',
            ),
            options,
          );
        ...
        it.v2(
          ...
          async function () {
            let b = await bundle(
              path.join(
                __dirname,
                '/../data/integration/scope-hoisting/es6/side-effects-no-new-bundle/index.html',
              ),
              options,
            );
      ...
      it('supports deferring unused ES6 re-exports (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports/a.js',
          ),
          options,
        );
      ...
      it('supports deferring an unused ES6 re-export (wildcard, empty, unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-all-empty/a.js',
          ),
          options,
        );
      ...
      it('supports deferring unused ES6 re-exports (reexport named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports/b.js',
          ),
          options,
        );
      ...
      it('supports deferring unused ES6 re-exports (namespace rename used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports/c.js',
          ),
          options,
        );
      ...
      it('supports deferring unused ES6 re-exports (direct export used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports/d.js',
          ),
          options,
        );
      ...
      it('supports chained ES6 re-exports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-chained/index.js',
          ),
          options,
        );
      ...
      it('should not optimize away an unused ES6 re-export and an used import', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-import/a.js',
          ),
          options,
        );
      ...
      it('should not optimize away an unused ES6 re-export and an used import (different symbols)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-import-different/a.js',
          ),
          options,
        );
      ...
      it.v2(
        ...
        async function () {
          let b = await bundle(
            path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-re-exports-library/a.js',
            ),
            options,
          );
          ...
          let contents = await outputFS.readFile(
            path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-re-exports-library/build.js',
            ),
            'utf8',
          );
      ...
      if (shouldScopeHoist) {
        it.v2(
          ...
          async function () {
            let testDir = path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-update-deferred-reexported',
            );
        ...
        it.v2(
          ...
          async function () {
            let testDir = path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-update-deferred-direct',
            );
        ...
        it('removes deferred reexports when imported from multiple asssets', async function () {
          let b = await bundle(
            path.join(
              __dirname,
              '/../data/integration/scope-hoisting/es6/side-effects-re-exports-multiple-dynamic/a.js',
            ),
            options,
          );
      ...
      it('keeps side effects by default', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects/a.js',
          ),
          options,
        );
      ...
      it('supports the package.json sideEffects: false flag', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-false/a.js',
          ),
          options,
        );
      ...
      it.v2('supports removing a deferred dependency', async function () {
        let testDir = path.join(
          __dirname,
          '/../data/integration/scope-hoisting/es6/side-effects-false',
        );
      ...
      it('supports wildcards', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-false-wildcards/a.js',
          ),
          options,
        );
        let called = false;
      ...
      it('correctly handles excluded and wrapped reexport assets', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-false-wrap-excluded/a.js',
          ),
          options,
        );
      ...
      it('supports the package.json sideEffects flag with an array', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-array/a.js',
          ),
          options,
        );
      ...
      it('supports the package.json sideEffects: false flag with shared dependencies', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-false-duplicate/a.js',
          ),
          options,
        );
      ...
      it('supports the package.json sideEffects: false flag with shared dependencies and code splitting', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-split/a.js',
          ),
          options,
        );
      ...
      it('supports the package.json sideEffects: false flag with shared dependencies and code splitting II', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-split2/a.js',
          ),
          options,
        );
      ...
      it('missing exports should be replaced with an empty object', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/empty-module/a.js',
          ),
          options,
        );
      ...
      it('supports namespace imports of theoretically excluded reexporting assets', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/import-namespace-sideEffects/index.js',
          ),
          options,
        );
      ...
      it('can import from a different bundle via a re-export', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/re-export-bundle-boundary-side-effects/index.js',
          ),
          options,
        );
      ...
      it('supports excluding multiple chained namespace reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-chained-re-exports-multiple/a.js',
          ),
          options,
        );
      ...
      it('supports excluding when doing both exports and reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-export-reexport/a.js',
          ),
          options,
        );
      ...
      it('supports deferring with chained renaming reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-rename-chained/a.js',
          ),
          options,
        );
      ...
      it('supports named and renamed reexports of the same asset (default used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-rename-same2/a.js',
          ),
          options,
        );
      ...
      it('supports named and renamed reexports of the same asset (named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-rename-same2/b.js',
          ),
          options,
        );
      ...
      it('supports named and renamed reexports of the same asset (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-rename-same/index.js',
          ),
          options,
        );
      ...
      it('supports reexports via variable declaration (unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-rename-var-unused/index.js',
          ),
          options,
        );
      ...
      it('supports named and namespace exports of the same asset (named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-namespace-same/a.js',
          ),
          options,
        );
      ...
      it('supports named and namespace exports of the same asset (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-namespace-same/b.js',
          ),
          options,
        );
      ...
      it('supports named and namespace exports of the same asset (both used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-namespace-same/c.js',
          ),
          options,
        );
      ...
      it('supports partially used reexporting index file', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-re-exports-partially-used/index.js',
          ),
          options,
        );
      ...
      it('supports deferring non-weak dependencies that are not used', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-semi-weak/a.js',
          ),
          options,
        );
      ...
      it.v2('supports excluding CommonJS (CommonJS unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-commonjs/a.js',
          ),
          options,
        );
      ...
      it.v2('supports excluding CommonJS (CommonJS used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/side-effects-commonjs/b.js',
          ),
          options,
        );
    ...
    it(`ignores missing unused import specifiers in source assets ${
      ...
      let b = await bundle(
        path.join(__dirname, '../data/integration/js-unused-import-specifier/a.js'),
        options,
      );
      let res = await run(b, null, {require: false});
    ...
    it(`ignores missing unused import specifiers in node-modules ${
      ...
      let b = await bundle(
        path.join(
          __dirname,
          '/../data/integration/js-unused-import-specifier-node-modules/a.js',
        ),
        options,
      );
    ...
    it(`duplicate assets should share module scope ${
      ...
      let b = await bundle(
        [
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/multi-entry-duplicates/one.js',
          ),
          path.join(
            __dirname,
            '/../data/integration/scope-hoisting/es6/multi-entry-duplicates/two.js',
          ),
        ],
