...
describe('bundler', function () {
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(__dirname, '../data/integration/min-bundles/index.js'),
        {
          mode: 'production',
          defaultTargetOptions: {
            shouldScopeHoist: false,
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/shared-bundle-reused-bundle-remove-reuse/index.js',
        ),
        {
          mode: 'production',
          defaultTargetOptions: {
  ...
  it.v2(
    ...
    async function () {
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/shared-bundle-reused-bundle-remove-shared/index.js',
        ),
        {
          mode: 'production',
          defaultTargetOptions: {
  ...
  it.v2(
    ...
    async function () {
      ...
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/shared-bundle-remove-from-one-group-only/index.js',
        ),
        {
          mode: 'production',
          defaultTargetOptions: {
  ...
  it.v2(
    ...
    async function () {
      ...
      let b = await bundle(
        path.join(
          __dirname,
          '../data/integration/shared-bundle-between-reused-bundle-removal/index.js',
        ),
        {
          mode: 'production',
          defaultTargetOptions: {
  ...
  it.v2('should split manifest bundle', async function () {
    let b = await bundle(
      [
        path.join(__dirname, '../data/integration/split-manifest-bundle/a.html'),
        path.join(__dirname, '../data/integration/split-manifest-bundle/b.html'),
      ],
      {
        mode: 'production',
        defaultTargetOptions: {
  ...
  it('should not split manifest bundle for stable entries', async function () {
    let b = await bundle(
      path.join(__dirname, '../data/integration/split-manifest-bundle/a.js'),
      {
        mode: 'production',
        defaultTargetOptions: {
          shouldScopeHoist: false,
