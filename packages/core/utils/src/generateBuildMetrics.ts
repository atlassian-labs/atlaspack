...
async function getSourcemapSizes(filePath: FilePath, fs: FileSystem, projectRoot: FilePath): Promise<Map<string, number> | null | undefined> {
...
export default async function generateBuildMetrics(bundles: Array<PackagedBundle>, fs: FileSystem, projectRoot: FilePath): Promise<BuildMetrics> {
  bundles
