...
export function normalizePath(filePath: FilePath, leadingDotSlash: boolean = true): FilePath {
  if (
    leadingDotSlash &&
    (filePath[0] !== '.' ||
...
export function relativePath(from: string, to: string, leadingDotSlash: boolean = true): FilePath {
  // Fast path
