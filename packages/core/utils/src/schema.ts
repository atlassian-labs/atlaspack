import ThrowableDiagnostic, {generateJSONCodeHighlights, escapeMarkdown, encodeJSONKeyComponent} from '@atlaspack/diagnostic';
...
function validateSchema(schema: SchemaEntity, data: unknown): Array<SchemaError> {
  function walk(schemaAncestors, dataNode: unknown, dataPath: string): SchemaError | null | undefined | Array<SchemaError> {
...
export function fuzzySearch(expectedValues: Array<string>, actualValue: string): Array<string> {
