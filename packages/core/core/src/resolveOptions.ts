...
async function findGitRepositoryRoot(inputFS: FileSystem, projectRoot: FilePath): Promise<null | FilePath> {
...
export default async function resolveOptions(initialOptions: InitialAtlaspackOptions): Promise<AtlaspackOptions> {
