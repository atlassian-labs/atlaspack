  ...
  return {
    ...
    run: async (input) => {
      ...
      let configResult = nullthrows(
        await input.api.runRequest<null, ConfigAndCachePath>(createAtlaspackConfigRequest()),
      );
...
class BundlerRunner {
  ...
  async bundle(
    ...
    let previousBundleGraphResult: BundleGraphRequestResult | null | undefined;
  ...
  async nameBundle(
    ...
    let bundleGraph = new BundleGraph<IBundle>(internalBundleGraph, NamedBundle.get.bind(NamedBundle), this.options);
