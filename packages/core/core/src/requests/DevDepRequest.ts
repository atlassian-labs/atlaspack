...
export async function runDevDepRequest<TResult extends RequestResult>(api: RunAPI<TResult>, devDepRequest: DevDepRequest) {
...
export function getWorkerDevDepRequests(devDepRequests: Array<DevDepRequest>): Array<DevDepRequest> {
