import type {DependencySpecifier, SemverRange, Invalidations} from '@atlaspack/types';
...
export async function getDevDepRequests<TResult extends RequestResult>(api: RunAPI<TResult>): Promise<DevDepRequests> {
...
export function resolveDevDepRequestRef(devDepRequestRef: DevDepRequest | DevDepRequestRef): DevDepRequest {
  const devDepRequest =
...
export async function runDevDepRequest<TResult extends RequestResult>(api: RunAPI<TResult>, devDepRequestRef: DevDepRequest | DevDepRequestRef) {
...
export function getWorkerDevDepRequests(devDepRequests: Array<DevDepRequest | DevDepRequestRef>): Array<DevDepRequest | DevDepRequestRef> {
