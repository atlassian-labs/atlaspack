...
export type WriteBundlesRequest = {
  ...
  run: (arg1: RunInput<WriteBundlesRequestResult>) => Async<WriteBundlesRequestResult>,
  input: WriteBundlesRequestInput
};
 ...
 */
export default function createWriteBundlesRequest(input: WriteBundlesRequestInput): WriteBundlesRequest {
  return {
