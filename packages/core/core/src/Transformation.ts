...
export default class Transformation {
  ...
  async runPipelines(pipeline: Pipeline, initialAsset: UncommittedAsset): Promise<Array<UncommittedAsset>> {
  ...
  async runPipeline(pipeline: Pipeline, initialAsset: UncommittedAsset): Promise<Array<UncommittedAsset>> {
  ...
  async loadPipeline(filePath: ProjectPath, isSource: boolean, pipeline?: string | null): Promise<Pipeline> {
  ...
  async loadTransformerConfig(transformer: LoadedPlugin<Transformer<unknown>>, isSource: boolean): Promise<Config | null | undefined> {
  ...
  async runTransformer(
    ...
    const resolve = async (from: FilePath, to: string, options?: ResolveOptions): Promise<FilePath> => {
    ...
    if (postProcess) {
      pipeline.postProcess = async (assets: Array<UncommittedAsset>): Promise<Array<UncommittedAsset> | null> => {
