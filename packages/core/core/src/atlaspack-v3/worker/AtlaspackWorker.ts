...
export type ResolverState<T> = {
  resolver: Resolver<T>;
  config?: T;
  packageManager?: NodePackageManager;
};

export type TransformerState<T> = {
  packageManager?: NodePackageManager;
...
export type RunResolverResolveOptions = {
  key: string;
...
export type RunResolverResolveResult = {
...
export type RunTransformerTransformOptions = {
  key: string;
...
export type RunTransformerTransformResult = [
  // @ts-expect-error TS2724
  napi.RpcAssetResult,
  Buffer,
  string,
