...
export class AtlaspackWorker {
  ...
  runResolverResolve: JsCallable<[RunResolverResolveOptions], Promise<RunResolverResolveResult>> = jsCallable(
  ...
  runTransformerTransform: JsCallable<[RunTransformerTransformOptions], Promise<RunTransformerTransformResult>> = jsCallable(async ({key, env: napiEnv, options, asset: innerAsset}) => {
