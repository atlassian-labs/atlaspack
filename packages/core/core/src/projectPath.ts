...
export const toProjectPath: ((projectRoot: FilePath, p: FilePath) => ProjectPath) & (// $FlowFixMe Not sure how to type properly
(projectRoot: FilePath, p: FilePath | undefined) => ProjectPath | undefined) & ((projectRoot: FilePath, p?: FilePath | null | undefined) => ProjectPath | null | undefined) = toProjectPath_;

function fromProjectPath_(projectRoot: FilePath, p?: ProjectPath | null): FilePath | null | undefined {
  if (p == null) {
    return null;
  }
...
(projectRoot: FilePath, p: ProjectPath) => FilePath) & ((projectRoot: FilePath, p?: ProjectPath | null | undefined) => FilePath | null | undefined) = fromProjectPath_;
 ...
 */
export function joinProjectPath(a: ProjectPath, ...b: Array<FilePath>): ProjectPath {
