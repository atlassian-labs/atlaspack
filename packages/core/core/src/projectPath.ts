...
export const toProjectPath: ((projectRoot: FilePath, p: FilePath) => ProjectPath) & ((projectRoot: FilePath, p: FilePath | undefined) => ProjectPath | undefined) & ((projectRoot: FilePath, p?: FilePath | null | undefined) => ProjectPath | null | undefined) = toProjectPath_;
...
export const fromProjectPath: ((projectRoot: FilePath, p: ProjectPath) => FilePath) & ((projectRoot: FilePath, p?: ProjectPath | null | undefined) => FilePath | null | undefined) = fromProjectPath_;
