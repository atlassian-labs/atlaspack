...
function outgoingDependencyNodesFromAsset(assetGraph: any, assetNode: NodeId) {
...
function dependencyNodesFromIds(assetGraph: any, dependencyIds: any) {
