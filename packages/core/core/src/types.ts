...
export type ExtendableAtlaspackConfigPipeline = ReadonlyArray<AtlaspackPluginNode | '...'>;
...
export type Dependency = {
  ...
  bundleBehavior: typeof BundleBehavior[keyof typeof BundleBehavior] | null | undefined,
  isEntry: boolean,
  isOptional: boolean,
  loc: InternalSourceLocation | null | undefined,
  env: Environment,
...
export type RequestInvalidation = FileInvalidation | EnvInvalidation | OptionInvalidation;
...
export type InternalFileCreateInvalidation = InternalFileInvalidation | InternalGlobInvalidation | InternalFileAboveInvalidation;
...
export type AssetGroup = Partial<Flow.Diff<AssetRequestInput, {
  optionsRef: SharedReference
}>>;
...
export type AssetGraphNode = AssetGroupNode | AssetNode | DependencyNode | EntrySpecifierNode | EntryFileNode | RootNode;

export type BundleGraphNode = AssetNode | DependencyNode | EntrySpecifierNode | EntryFileNode | RootNode | BundleGroupNode | BundleNode;
