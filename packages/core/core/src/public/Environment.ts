...
const internalEnvironmentToEnvironment: WeakMap<InternalEnvironment, Environment> = new WeakMap();
const _environmentToInternalEnvironment: WeakMap<IEnvironment, InternalEnvironment> = new WeakMap();
export function environmentToInternalEnvironment(environment: IEnvironment): InternalEnvironment {
...
export default class Environment implements IEnvironment {
  ...
  matchesEngines(minVersions: VersionMap, defaultValue: boolean = false): boolean {
