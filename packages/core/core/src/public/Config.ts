...
const internalConfigToConfig: DefaultWeakMap<AtlaspackOptions, WeakMap<Config, PublicConfig>> = new DefaultWeakMap(() => new WeakMap());
 ...
 *
 */
export function makeConfigProxy<T>(onRead: (path: string[]) => void, config: T): T {
