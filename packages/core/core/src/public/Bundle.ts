...
const internalBundleToBundle: DefaultWeakMap<AtlaspackOptions, DefaultWeakMap<BundleGraph, WeakMap<InternalBundle, Bundle>>> = new DefaultWeakMap(() => new DefaultWeakMap(() => new WeakMap()));
const internalBundleToNamedBundle: DefaultWeakMap<AtlaspackOptions, DefaultWeakMap<BundleGraph, WeakMap<InternalBundle, NamedBundle>>> = new DefaultWeakMap(() => new DefaultWeakMap(() => new WeakMap()));
const internalBundleToPackagedBundle: DefaultWeakMap<AtlaspackOptions, DefaultWeakMap<BundleGraph, WeakMap<InternalBundle, PackagedBundle>>> = new DefaultWeakMap(() => new DefaultWeakMap(() => new WeakMap()));
...
let _private: Record<string, any> = {};
