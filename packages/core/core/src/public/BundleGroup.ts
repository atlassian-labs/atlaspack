...
const internalBundleGroupToBundleGroup: WeakMap<InternalBundleGroup, BundleGroup> = new WeakMap();
const _bundleGroupToInternalBundleGroup: WeakMap<IBundleGroup, InternalBundleGroup> = new WeakMap();
export function bundleGroupToInternalBundleGroup(target: IBundleGroup): InternalBundleGroup {
