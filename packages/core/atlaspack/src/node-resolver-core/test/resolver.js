...
import {ncp, overlayFS, outputFS} from '../../test-utils/index.js';
import {loadConfig as configCache} from '../../utils/index.js';
import {createEnvironment} from '../../core/Environment.js';
import Environment from '../../core/public/Environment.js';
import {DEFAULT_OPTIONS} from '../../core/test-utils.js';
import {setFeatureFlags, DEFAULT_FEATURE_FLAGS} from '../../feature-flags/index.js';
...
describe('resolver', function () {
    ...
    it('should resolve node builtin modules', async function () {
      ...
      check(resolved, {
        ...
        invalidateOnFileChange: [
          ...
          require.resolve('browserify-zl/package.json'),
        ],
      });
    });
  ...
  describe('error handling', function () {
    ...
    it('should error on non-exported package paths', async function () {
      ...
      let file = path.join(
        rootDir,
        'node_modules/package-expor/package.json',
      );
      assert.deepEqual(result?.diagnostics, [
        {
