    ...
    check(
      ...
      ),
      {
        ...
        invalidateOnFileChange: new Set([
          path.join(FIXTURES_DIR, 'has-foo/node_modules/f/package.json'),
        ]),
        invalidateOnFileCreate: [
          {
            filePath: path.join(
  ...
  it("autoinstalls packages that don't exist", async () => {
    ...
    check(
      ...
      ),
      {
        ...
        type: 1,
        invalidateOnFileChange: new Set([
          path.join(FIXTURES_DIR, 'has-foo/node_modules/package.json'),
        ]),
        invalidateOnFileCreate: [
          {
            filePath: path.join(
      ...
      [
        {
          ...
          packagePath: path.join(FIXTURES_DIR, 'has-f/package.json'),
          fs,
          saveDev: true,
      ...
      [
        {
          ...
          packagePath: path.join(FIXTURES_DIR, 'emp/package.json'),
          fs,
          saveDev: true,
          modules: [{name: 'peers', range: undefined}],
        },
      ...
      check(
        ...
        ),
        {
          ...
          invalidateOnFileChange: new Set([
            path.join(
              FIXTURES_DIR,
              'has-foo/subpackage/node_modules/f/package.json',
            ),
          ]),
          invalidateOnFileCreate: [
            {
