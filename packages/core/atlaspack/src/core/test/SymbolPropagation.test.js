...
import type {FilePath, SourceLocation, Meta, Symbol} from '../../types/index.js';
import type {ContentKey, NodeId} from '../../graph/index.js';
import type {Diagnostic} from '../../diagnostic/index.js';
import ThrowableDiagnostic from '../../diagnostic/index.js';
import {setEqual} from '../../utils/index.js';
import AssetGraph, {
  nodeFromAssetGroup,
  nodeFromDep,
  nodeFromEntryFile,
...
import {createDependency as _createDependency} from '../Dependency';
import {createAsset as _createAsset} from '../assetUtils';
import {
