...
import type {ContentKey} from '../graph/index.js';
import type {Dependency, NamedBundle as INamedBundle} from '../types/index.js';
import type {SharedReference} from '../workers/index.js';
import type {
  Asset,
  AssetGroup,
...
import {PluginLogger} from '../logger/index.js';
import {hashString} from '../rust/index.js';
import ThrowableDiagnostic, {errorToDiagnostic} from '../diagnostic/index.js';
...
import {tracer, PluginTracer} from '../profiler/index.js';
import {DefaultMap} from '../utils/index.js';
