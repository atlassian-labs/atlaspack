 ...
 */
export function getJSONHighlightLocation(pos: Mapping, type?: 'key' | null | undefined | 'value'): {
  start: DiagnosticHighlightLocation,
  end: DiagnosticHighlightLocation
} {
...
export function getJSONSourceLocation(pos: Mapping, type?: 'key' | null | undefined | 'value'): {
  start: {
    readonly line: number,
    readonly column: number
  },
...
export function convertSourceLocationToHighlight<Location extends {
  /** 1-based, inclusive */
  readonly start: {
    readonly line: number,
    readonly column: number
...
export function md(strings: Array<string>, ...params: Array<TemplateInput>): string {
