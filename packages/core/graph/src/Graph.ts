...
export default class Graph<TNode, TEdgeType extends number = 1> {
  ...
  static deserialize<TNode, TEdgeType extends number = 1>(opts: GraphOpts<TNode, TEdgeType>): Graph<TNode, TEdgeType> {
    return new this({
      nodes: opts.nodes,
  ...
  getNodeIdsConnectedTo(
    nodeId: NodeId,
    type: TEdgeType | NullEdgeType | Array<TEdgeType | NullEdgeType> | AllEdgeTypes = 1,
  ): Array<NodeId> {
