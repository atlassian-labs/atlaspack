...
export type GlobMap<T> = Partial<Record<Glob, T>>;
 ...
 */
type PackageDependencies = Partial<Record<PackageName, Semver>>;
...
export type InitialAtlaspackOptionsInternal<WorkerFarm> = {
  ...
  readonly napiWorkerPool?: NapiWorkerPool;
...
export interface MutableAsset extends BaseAsset {
  ...
  addDependency(arg1: DependencyOptions): string;
  /**
  ...
  setCode(arg1: string): void;
  /** Sets the asset contents as a buffer. */
  setBuffer(arg1: Buffer): void;
  /** Sets the asset contents as a stream. */
  setStream(arg1: Readable): void;
  /** Sets the asset's AST. */
  setAST(arg1: AST): void;
...
export interface Config {
  ...
  /**
     ...
     */
  addDevDependency(arg1: DevDepOptions): void;
  /**
...
export interface MutableBundleGraph extends BundleGraph<Bundle> {
  ...
  addAssetToBundle(arg1: Asset, arg2: Bundle): void;
  /**
  ...
  addBundleToBundleGroup(arg1: Bundle, arg2: BundleGroup): void;
  createAssetReference(arg1: Dependency, arg2: Asset, arg3: Bundle): void;
  createBundleReference(arg1: Bundle, arg2: Bundle): void;
  /** Creates a conditional relationship in the graph between two bundles
     ...
     */
  createBundleConditionalReference(arg1: Bundle, arg2: Bundle): void;
  createBundle(arg1: CreateBundleOpts): Bundle;
  /** Turns an edge (Dependency -> Asset-s) into (Dependency -> BundleGroup -> Asset-s) */
  createBundleGroup(arg1: Dependency, arg2: Target): BundleGroup;
  /** @returns all Asset-s attached to the Dependency */
  getDependencyAssets(arg1: Dependency): Array<Asset>;
  /** Get Bundles that load this bundle asynchronously. */
  getParentBundlesOfBundleGroup(arg1: BundleGroup): Array<Bundle>;
  /** @returns the size in bytes of an asset and all assets in its subgraph */
  getTotalSize(arg1: Asset): number;
  /**
     * Recursively removes an asset and its dependencies from a bundle. Stops at
     * bundle group boundaries.
     */
  removeAssetGraphFromBundle(arg1: Asset, arg2: Bundle): void;
  /**
...
export interface BundleGraph<TBundle extends Bundle> {
  ...
  getBundlesWithDependency(arg1: Dependency): Array<TBundle>;
  /**
...
export type PackagingAndOptimizingProgressEvent = {
  readonly type: 'buildProgress';
  readonly phase: 'packagingAndOptimizing';
  readonly totalBundles: number;
  readonly completeBundles: number;
};
 ...
 * @section reporter
 */
export type BuildProgressEvent = ResolvingProgressEvent | TransformingProgressEvent | BundlingProgressEvent | BundledProgressEvent | PackagingProgressEvent | OptimizingProgressEvent | PackagingAndOptimizingProgressEvent;
