...
import type { FileSystem, FileOptions, Stats as FileStats, ReaddirOptions, Encoding, Dirent } from "./FileSystem.mts";
import type { AST as _AST, ConfigResult as _ConfigResult } from "./unsafe.mts";
import type { FilePath } from "./FilePath.mts";
import type { Glob } from "./Glob.mts";
import type { PackageName } from "./PackageName.mts";
import type { PackageManager, PackageManagerResolveResult, Invalidations, PackageInstaller, ModuleRequest, InstallOptions, InstallerOptions } from "./PackageManager.mts";
import type { SemverRange } from "./SemverRange.mts";
import type { DependencySpecifier } from "./DependencySpecifier.mts";
import type { FileCreateInvalidation, GlobInvalidation, FileInvalidation, FileAboveInvalidation } from "./FileCreateInvalidation.mts";
import type { NapiWorkerPool } from "./NapiWorkerPool.mts";
...
export type RawAtlaspackConfig = {
  ...
  transformers?: Record<Glob, RawAtlaspackConfigPipeline>;
  bundler?: PackageName;
  namers?: RawAtlaspackConfigPipeline;
  runtimes?: RawAtlaspackConfigPipeline;
  packagers?: Record<Glob, PackageName>;
  optimizers?: Record<Glob, RawAtlaspackConfigPipeline>;
  compressors?: Record<Glob, RawAtlaspackConfigPipeline>;
...
export interface BaseAsset {
  ...
  getMap(): Promise<SourceMap.default | null | undefined>;
...
export interface MutableAsset extends BaseAsset {
  ...
  setMap(arg0: SourceMap.default | null | undefined): void;
...
export type GenerateOutput = {
  ...
  readonly map?: SourceMap.default | null | undefined;
};
...
export type Packager<ConfigType, BundleConfigType> = {
  ...
  package(arg0: {
    ...
    getSourceMapReference: (map: SourceMap.default | null | undefined) => Async<string | null | undefined>;
  }): Async<BundleResult>;
};
...
export type Optimizer<ConfigType, BundleConfigType> = {
  ...
  optimize(arg0: {
    ...
    bundleGraph: BundleGraph<NamedBundle>;
    contents: Blob;
    map: SourceMap.default | null | undefined;
    options: PluginOptions;
    logger: PluginLogger;
    tracer: PluginTracer;
    config: ConfigType;
