...
export declare function atlaspackDevServerCreate(options: JsDevServerOptions, dataProvider: object): ExternalObject<JsDevServer>
export declare function atlaspackDevServerStart(server: ExternalObject<JsDevServer>): Promise<JsDevServerStartResult>
export declare function atlaspackDevServerStop(server: ExternalObject<JsDevServer>): Promise<void>
