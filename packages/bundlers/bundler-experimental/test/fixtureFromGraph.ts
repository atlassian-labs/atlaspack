 ...
 */
export function asset(path: string, dependencies?: string | DependencySpec[]): GraphEntry {
  return {
    type: 'asset',
    value: {
      filePath: path,
 ...
 */
export async function fixtureFromGraph(dirname: string, fs: FileSystem, entries: GraphEntry[]): Promise<string> {
