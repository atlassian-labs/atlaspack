import type {Asset, ConfigResult, PluginOptions, ValidateResult} from '@atlaspack/types';
...
function tryCreateLanguageService(config: TSValidatorConfig, asset: Asset, options: PluginOptions): void {
...
function getValidateResultFromDiagnostics(filePath: string, diagnostics: ReadonlyArray<Diagnostic>): ValidateResult {
  let validatorResult = {
    warnings: [],
    errors: [],
  };
