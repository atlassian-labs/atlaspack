...
function collectSrcSetDependencies(asset: MutableAsset, srcset: string, opts: any) {
...
function getAttrDepHandler(attr: string) {
  ...
  return (asset: MutableAsset, src: string, opts: any) => asset.addURLDependency(src, opts);
}
