...
export const createImportClause: (
  ...
  if (majorVersion > 4 || (majorVersion === 4 && minorVersion >= 0)) {
    return (factory: any, isTypeOnly: boolean, name: undefined | Identifier, namedBindings: undefined | NamedImportBindings) =>
...
export const createImportDeclaration: (
  ...
  if (majorVersion > 4 || (majorVersion === 4 && minorVersion >= 8)) {
    return (factory: any, modifiers: undefined | Array<Modifier>, importClause: undefined | ImportClause, moduleSpecifier: Expression, assertClause: AssertClause) =>
    ...
    return (factory: any, modifiers: undefined | Array<Modifier>, importClause, moduleSpecifier: Expression, assertClause: AssertClause) =>
      factory.createImportDeclaration(
    ...
    return (factory: any, modifiers, importClause: undefined | ImportClause, moduleSpecifier, assertClause: AssertClause) =>
      factory.createImportDeclaration(
        undefined /* decorators */,
        modifiers,
        importClause,
...
export const createImportSpecifier: (
  ...
  if (majorVersion > 4 || (majorVersion === 4 && minorVersion >= 5)) {
    return (factory: any, isTypeOnly: boolean, propertyName, name: Identifier) =>
      factory.createImportSpecifier(isTypeOnly, propertyName, name);
  } else if (majorVersion > 3 || (majorVersion === 3 && minorVersion >= 0)) {
    return (factory: any, isTypeOnly: boolean, propertyName: undefined | Identifier, name: Identifier) =>
