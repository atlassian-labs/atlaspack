...
- [#1111](https://github.com/atlassian-labs/atlaspack/pull/1111) [`c97de81`](https://github.com/atlassian-labs/atlaspack/commit/c97de81b0b4b866bef4396e9131f37ffd273258d) Thanks [@xtan-atlas](https://github.com/xtan-atlas)! - Add `cssMapScoped` API to the Rust/SWC pipeline — a dedicated, non-atomic variant of `cssMap`.
