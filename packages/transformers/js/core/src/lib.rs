        ...
        swc_core::common::errors::HANDLER.set(&handler, || {
          helpers::HELPERS.set(
            ...
            || {
              ...
              println!("Generated CSS rules from Rust: {:?}", generated_css_rules);
              result.compiled_css_rules = generated_css_rules.clone();
              println!("Stored in result.compiled_css_rules: {:?}", result.compiled_css_rules);
