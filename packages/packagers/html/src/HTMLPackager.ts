...
function insertBundleReferences(siblingBundles: Array<NamedBundle>, tree: any, conditionalBundles: Set<NamedBundle>) {
  const bundles = [];
...
function getReferencedConditionalScripts(bundleGraph: BundleGraph<NamedBundle>, referencedBundles: NamedBundle[]): Set<NamedBundle> {
