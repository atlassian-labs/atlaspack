...
function errorToThrowableDiagnostic(error: string, dependency: Dependency): ThrowableDiagnostic {
...
function set(obj, path: Array<never> | Array<string>, value: FilePath | string) {
