...
// for (const packageName of fs.readdirSync(path.join(__root, 'packages', 'utils'))) {

//   const packagePath = path.join(__root, 'packages', 'utils', packageName)
//   const packagePathDest = path.join(__root, 'packages', 'shims', `utils-${packageName}`)
//   const packageJsonPath = path.join(packagePath, 'package.json')
