...
| ------------------- | ------------------------ | ----------------------------------------------------------------------------------------------------- |
| jsx_pragma          | String                   | Specifies the JSX pragma to use (e.g., "React.createElement").                                        |
| jsx_pragma_fragment | String                   | Specifies the JSX fragment pragma to use (e.g., "React.Fragment").                                    |
| jsx_import_source   | String                   | Specifies the import source for JSX. Only relevant for automatic runtime                              |
