...
use atlaspack::rpc::nodejs::NodejsRpcFactoryOld;
...
#[napi(object)]
pub struct AtlaspackNapiOptionsOld {
...
#[napi]
pub struct AtlaspackNapiOld {
  atlaspack: AtlaspackLazy,
}

#[napi]
impl AtlaspackNapiOld {
  #[tracing::instrument(level = "info", skip_all)]
  #[napi]
  pub fn create(
    napi_options: AtlaspackNapiOptionsOld,
    lmdb: &LMDB,
    env: Env,
  ) -> napi::Result<Self> {
    ...
    let rpc = Arc::new(NodejsRpcFactoryOld::new(rx_workers)?);
