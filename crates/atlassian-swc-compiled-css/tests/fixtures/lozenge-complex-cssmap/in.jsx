...
const stylesNew = cssMap({
  ...
  'bg.subtle.default': { backgroundColor: '#F4F5F7' },
  'bg.subtle.inprogress': { backgroundColor: '#F4F5F7' },
  'bg.subtle.moved': { backgroundColor: '#F4F5F7' },
  'bg.subtle.new': { backgroundColor: '#F4F5F7' },
  'bg.subtle.removed': { backgroundColor: '#F4F5F7' },
  'bg.subtle.success': { backgroundColor: '#F4F5F7' },
...
function LozengeComponent({ appearance, isBold }) {
  ...
  return (
    ...
    >
      <span css={[stylesNew.text, stylesNew[`text.${appearanceStyle}`]]}>
        Content
      </span>
    </span>
  );
