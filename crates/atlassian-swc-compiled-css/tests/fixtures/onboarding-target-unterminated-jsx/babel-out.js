...
export const TargetInner = ({
  ...
  ...props
    ...
    {<Base bgColor={bgColor} className={ax([pulse && "", pulse && "_5sagi11n _tip812c5 _j7hqp8mc _1pglmcjr _16qs1e2z", "_1bumglyw _sedtglyw", className])} radius={radius} testId={testId} {...props} style={{
    ...props.style,
