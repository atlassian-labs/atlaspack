...
const _3 = "@media (min-width:64rem){._glte25cg{width:var(--aside-width)}._ndwch9n0{justify-self:end}._165tk7wh{height:calc(100vh - 3pc)}._13wn1if8{position:sticky}}";
const _4 = "._1reo1wug{overflow-x:auto}";
const _5 = "._18m91wug{overflow-y:auto}";
const _6 = "._152tckbl{inset-block-start:3pc}";
    ...
    return (jsxs(CC, {
        children: [
            ...
            jsx("aside", {
                ...
                "data-testid": testId,
                className: ax([
                    "_nd5lns35 _vchhusvi _kqswh2mm _glte25cg _ndwch9n0",
                    styles.root
                ]),
                children: jsx("div", {
                    css: styles.inner,
